...
<body>
    ...
    <div class="content vertical-center">
        ...
        <form class="form-horizontal p-centered" action="change_password.php" method="post">

            <input class="form-input" type="hidden" id="id" name="id" value="<?= $id ?>">

            <div class="form-group">
                <!-- <label class="form-label" for="NameUser">Username</label>  -->
                <input class="form-input" type="hidden" id="NameUser" name="NameUser" placeholder="Username" value="<?= $data[1] ?>">
            </div>

            <div class="form-group">
                <label class="form-label" for="pwd">Password</label> 
                <input class="form-input" type="password" id="pwd" name="PasswordUser" placeholder="Password" value="<?= $data[2] ?>">
            </div>

            <div class="form-group">
                <label class="form-label" for="valid-password">ConfirmPassword</label> 
                <input class="form-input" type="password" id="valid-password" name="valid-password" placeholder="Password" value="<?= $data[2] ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-input" type="hidden" id="DescUser" name="DescUser" value="<?= $data[3] ?>">
            </div>

            <div class="form-group">
                <!-- <label class="form-label" for="ImgUser">Profil picture</label>  -->
                <input class="form-input" type="hidden" id="ImgUser" name="ImgUser" value="<?= $data[4] ?>">
            </div>

            <input  class="btn" type="submit" value="Sauvegarder">
            <a class="btn" onclick="window.location.href='../profil?id=<?= $id ?>.php'">Retour</a>
